...
| The amulet in the right hand | `$3F85` = 0, `$3FC5` = 0 (16261: 0, 16325: 0), so the player holds object `$15`; `$4C01` = `$15` (19457: 21) | live: then PUT DOWN on the pedestal cell `$9677` won the game |
