...
| **Transporter doors**, marked by a diagonal or a cross; one reverses east and west (Zzap 13, Zzap 18, site's table) | traced | booths `$72`-`$87`: cross two-way (door 0 relinked on entry, `$9119`), diagonal one-way, `$72` random among eight, `$7F` toggles `$F1`, entered from room `$90` only (both its links name `$56`): the stick's left and right swap and the view mirrors |
