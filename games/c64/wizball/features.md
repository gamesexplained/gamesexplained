...
| **Music and sound** (Zzap, wiki): Martin Galway's title tune, a high-score tune and jingles, and sound effects | traced | nine tunes (`$5525`) and 26 effects (`$3C5F`); see `facts.md` |
